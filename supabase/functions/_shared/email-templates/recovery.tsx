  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Recebemos um pedido para redefinir a senha da sua conta na Axtor.
          Clique no botão abaixo para escolher uma nova — o link expira em breve.
        </Text>
        <Button style={button} href={confirmationUrl}>
          Redefinir minha senha
        </Button>
        <Text style={small}>
          Se você não solicitou essa redefinição, pode ignorar este email com
          tranquilidade — sua senha permanece a mesma.
        </Text>
